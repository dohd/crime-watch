...
class DivisionController extends Controller
{
    ...
    {
        if (request()->ajax()) {
            $data = Division::orderBy('created_at', 'DESC')->get();
        ...
        $county=County::get()->pluck('name','id');
        return view('settings.division.index',compact('regionCount','countyCount','divisionCount','stationCount','county'));
    }
    ...
    {
        $county=County::get()->pluck('name','id');
        return view('settings.division.edit',compact('division','county'));
    }
