...
$(function () {
  ...
  if (dtUserTable.length) {
    ...
    ajax: "{{ route('dailyincidences.index') }}", // JSON file to add data
      columns: [
     ...
     
        {
          ...
          render: function (data, type, full, meta) {
            return (
              ...
              '<a href="dailyincidences/'+full['uuid']+'/edit"  class="dropdown-item">' +
              feather.icons['file-text'].toSvg({ class: 'font-small-4 me-50' }) +
              'Edit</a>' +
              '<a href="javascript:;" data-href="dailyincidences/'+full['uuid']+'" class="delete-incidence dropdown-item delete-record">' +
