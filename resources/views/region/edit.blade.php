...
@section('content')
    ...
    <div class="content-wrapper container-xxl p-0">
        <div class="content-header row">
            <div class="content-header-left col-md-9 col-12 mb-2">
                <div class="row breadcrumbs-top">
                    <div class="col-12">
                        <h2 class="content-header-title float-start mb-0">Regional Incidences</h2>
        ...
        <div class="content-body">
            <!-- Basic Inputs start -->
            {{ Form::model($regionincidences, ['route' => ['regionalincidence.update', $regionincidences], 'class' => 'validate-form  modal-content pt-0 add-new-incidence', 'role' => 'form', 'method' => 'PUT', 'id' => 'category_add_form']) }}
