            ...
            <section class="app-user-list">
                ...
                <div class="card">
                    <div class="card-body border-bottom">
                        <h4 class="card-title">Manage Regional Offences</h4>
                        <div class="row">
...
$(function () {
  ...
  if (dtUserTable.length) {
    ...
    ajax: "{{ route('regionalincidence.index') }}", // JSON file to add data
      columns: [
     ...
     
        {
          ...
          render: function (data, type, full, meta) {
            return (
              ...
              '<a href="regionalincidence/'+full['uuid']+'/edit"  class="dropdown-item">' +
              feather.icons['file-text'].toSvg({ class: 'font-small-4 me-50' }) +
              'Edit</a>' +
              '<a href="javascript:;" data-href="regionalincidence/'+full['uuid']+'" class="delete-incidence dropdown-item delete-record">' +
      ...
      initComplete: function () {
        ...
        this.api()
          ...
          .every(function () {
            var column = this;
            var label = $('<label class="form-label" for="UserRole">Date</label>').appendTo('.user_role');
            var select = $(
        ...
        this.api()
          ...
          .every(function () {
            var column = this;
            var label = $('<label class="form-label" for="UserPlan">Month</label>').appendTo('.user_plan');
            var select = $(
        ...
        this.api()
          ...
          .every(function () {
            var column = this;
            var label = $('<label class="form-label" for="Region">Region</label>').appendTo('.region');
            var select = $(
              '<select id="region" class="form-select text-capitalize mb-md-0 mb-2"><option value=""> Select </option></select>'
            )
              .appendTo('.region')
              .on('change', function () {
                var val = $.fn.dataTable.util.escapeRegex($(this).val());
        ...
        this.api()
          ...
          .every(function () {
            var column = this;
            var label = $('<label class="form-label" for="county">County</label>').appendTo('.county');
            var select = $(
              '<select id="county" class="form-select text-capitalize mb-md-0 mb-2"><option value=""> Select </option></select>'
            )
              .appendTo('.county')
              .on('change', function () {
                var val = $.fn.dataTable.util.escapeRegex($(this).val());
...
$(document).on('click', '.edit-station', function() {
   // alert($(this).data('href'));
    ...
    $(document).on('click', '.delete-incidence', function(e) {
                e.preventDefault();
                Swal.fire({
                    type: 'warning',
                  title: "Are You Sure",
                  ...
                  dangerMode: true,
                    ...
                    if (willDelete.value) {
                      ...
                      Swal.fire('No Incident  deleted', '', 'info')
                    }
                });
            });
</script>
