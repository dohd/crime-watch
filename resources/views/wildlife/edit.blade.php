@extends('layouts.app')
@section('title', 'WILDLIFE-INCIDENT')
...
<!-- BEGIN: Content-->
    ...
    <div class="content-wrapper container-xxl p-0">
        <div class="content-header row">
          <div class="content-header-left col-md-9 col-12 mb-2">
            <div class="row breadcrumbs-top">
                <div class="col-12">
                    <h2 class="content-header-title float-start mb-0">WILDLIFE</h2>
        ...
        <div class="content-body">
            {{ Form::model($wildlifeincidence, ['route' => ['wildlife.update', $wildlifeincidence], 'class' => 'validate-form  modal-content pt-0 add-new-incidence', 'role' => 'form', 'method' => 'PUT', 'id' => 'category_add_form']) }}
            <!-- Basic Inputs start -->
           
            @include('wildlife.form')  
            <section>
              <div class="row">
                  <div class="col-12">
                      <div class="card">
...
$(document).on('click', '.edit-county', function() {
  ...
  $(document).ready(function() {
            function updateTotals() {
                ...
                $('#myTable tfoot th.s_total').each(function() {
                ...
                $('#myTable tfoot th.g_total').text(grandTotal);
            }
            // Call the function initially
            updateTotals();
            // Listen for changes in input values
            $('#myTable tbody').on('change', '.data-input', function() {
                updateTotals();
            });
        });    
</script>
