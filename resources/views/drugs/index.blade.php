            ...
            <section class="app-user-list">
                ...
                <div class="card">
                    <div class="card-body border-bottom">
                        <h4 class="card-title">Manage  Drugs  Offences</h4>
                        <div class="row">
...
$(function () {
  ...
  if (dtUserTable.length) {
    ...
    ajax: "{{ route('drug.index') }}", // JSON file to add data
      columns: [
     ...
     
        {
          ...
          render: function (data, type, full, meta) {
            return (
              ...
              '<a href="drug/'+full['uuid']+'/edit"  class="dropdown-item">' +
              feather.icons['file-text'].toSvg({ class: 'font-small-4 me-50' }) +
              'Edit</a>' +
              '<a href="javascript:;" data-href="drug/'+full['uuid']+'" class="delete-incidence dropdown-item delete-record">' +
