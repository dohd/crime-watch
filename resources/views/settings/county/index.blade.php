            ...
            <section class="app-user-list">
                ...
                <div class="card">
                    <div class="card-body border-bottom">
                        <h4 class="card-title">Manage Counties</h4>
                        <div class="row">
                    ...
                    <div class="modal modal-slide-in new-county-modal fade" id="modals-slide-in">
                        <div class="modal-dialog">
                            {!! Form::open(['route' => 'county.store', 'method' => 'post', 'class' => 'add-new-county modal-content pt-0', 'id' => 'add_county' ]) !!}
                    ...
                    <!-- Modal to add new region Ends-->
                       ...
                       <div class="modal modal-slide-in editCountyModal fade" id="modals-slide-in">
