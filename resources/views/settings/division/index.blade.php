@extends('layouts.app')
@section('title', 'Settings-Divisions')
<style>
.hide{
	display: none;
}
        ...
        <div class="content-body">
            ...
            <section class="app-user-list">
                ...
                <div class="card">
                    ...
                    <!-- Modal to add new division starts-->
                    <div class="modal modal-slide-in new-division-modal fade" id="modals-slide-in">
                        <div class="modal-dialog">
                            {!! Form::open(['route' => 'division.store', 'method' => 'post', 'class' => 'add-new-division modal-content pt-0', 'id' => 'add_region' ]) !!}
                    ...
                    <!-- Modal to add new region Ends-->
                       ...
                       <div class="modal modal-slide-in editDivisionModal fade" id="modals-slide-in">
...
$(function () {
  ...
  var dtUserTable = $('.user-list-table'),
    newUserSidebar = $('.new-division-modal'),
    newUserForm = $('.add-new-division'),
    select = $('.select2'),
  ...
  if (dtUserTable.length) {
    ...
    ajax: "{{ route('division.index') }}", // JSON file to add data
      columns: [
      ...
      
        {
          ...
          render: function (data, type, full, meta) {
            return (
              ...
              '<a href="javascript:;" data-href="division/'+full['id']+'/edit" class="edit-division dropdown-item">' +
              feather.icons['file-text'].toSvg({ class: 'font-small-4 me-50' }) +
              'Edit</a>' +
              '<a href="javascript:;" data-href="division/'+full['id']+'" class="delete-division dropdown-item delete-record">' +
      ...
      initComplete: function () {
        ...
        this.api()
          ...
          .every(function () {
            var column = this;
            var label = $('<label class="form-label" for="UserRole">County</label>').appendTo('.user_role');
            var select = $(
              '<select id="UserRole" class="form-select text-capitalize mb-md-0 mb-2"><option value=""> Select County </option></select>'
            )
              .appendTo('.user_role')
              .on('change', function () {
...
$(document).on('click', '.edit-division', function() {
   // alert($(this).data('href'));
           ...
           $('div.editDivisionModal').load($(this).data('href'), function() {
               $(this).modal('show');
        
               $('form#edit_division').submit(function(e) {
                   e.preventDefault();
                   $(this)
                  ...
                  processData:false,
                       success: function(result) {
                           if (result.success == true) {
                               $('div.editDivisionModal').modal('hide');
                               Swal.fire({
                     position: 'top-end',
                     icon: 'success',
                     title: result.msg,
                ...
                Swal.fire({
                  ...
                  dangerMode: true,
                    ...
                    if (willDelete.value) {
                      ...
                      Swal.fire('Division not deleted', '', 'info')
                    }
                });
            });
