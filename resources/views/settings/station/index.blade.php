        ...
        <div class="content-body">
            ...
            <section class="app-user-list">
                ...
                <div class="card">
                    ...
                    <div class="modal modal-slide-in new-station-modal fade" id="modals-slide-in">
                        <div class="modal-dialog">
                            {!! Form::open(['route' => 'station.store', 'method' => 'post', 'class' => 'add-new-station modal-content pt-0', 'id' => 'add_station' ]) !!}
                                ...
                                <div class="modal-body flex-grow-1">
                                    ...
                                    <div class="mb-1">
                                        ...
                                        {!! Form::select('county_id',[],null,['placeholder' => '-- Enter County --', 'class'=>' select2 form-control','id'=> 'county_id','required'=>'required']) !!}
          
                                    </div>
                                    <div class="mb-1">
                                        <label class="form-label" for="basic-icon-default-name">Enter Division</label>
                                        {!! Form::select('division_id',[],null,['placeholder' => '-- Enter Division --', 'class'=>' select2 form-control','id'=> 'division_id','required'=>'required']) !!}
                    ...
                    <!-- Modal to add new region Ends-->
                       ...
                       <div class="modal modal-slide-in editStationModal fade" id="modals-slide-in">
