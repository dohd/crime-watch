@extends('layouts.app')
@section('title', 'Settings-Regions')
<style>
.hide{
	display: none;
}
        ...
        <div class="content-body">
            ...
            <section class="app-user-list">
                ...
                <div class="card">
                    ...
                    <div class="modal modal-slide-in new-region-modal fade" id="modals-slide-in">
                        <div class="modal-dialog">
                            {!! Form::open(['route' => 'region.store', 'method' => 'post', 'class' => 'add-new-region modal-content pt-0', 'id' => 'add_region' ]) !!}
                    ...
                    <!-- Modal to add new region Ends-->
                       ...
                       <div class="modal modal-slide-in editRegionModal fade" id="modals-slide-in">
...
$(function () {
  ...
  var dtUserTable = $('.user-list-table'),
    newUserSidebar = $('.new-region-modal'),
    newUserForm = $('.add-new-region'),
    select = $('.select2'),
  ...
  if (dtUserTable.length) {
    ...
    ajax: "{{ route('region.index') }}", // JSON file to add data
      columns: [
        ...
        },
        {
          ...
          render: function (data, type, full, meta) {
            return (
              ...
              '<a href="javascript:;" data-href="region/'+full['id']+'/edit" class="edit-region dropdown-item">' +
              feather.icons['file-text'].toSvg({ class: 'font-small-4 me-50' }) +
              'Details</a>' +
              '<a href="javascript:;" data-href="region/'+full['id']+'" class="delete-region dropdown-item delete-record">' +
...
$(document).on('click', '.edit-region', function() {
   // alert($(this).data('href'));
           ...
           $('div.editRegionModal').load($(this).data('href'), function() {
               $(this).modal('show');
        
               $('form#edit_region').submit(function(e) {
                   e.preventDefault();
                   $(this)
                  ...
                  processData:false,
                       success: function(result) {
                           if (result.success == true) {
                               $('div.editRegionModal').modal('hide');
                               Swal.fire({
                     position: 'top-end',
                     icon: 'success',
                     title: result.msg,
