@extends('layouts.app')
@section('title', 'Settings-Incident File')
<style>
.hide{
	display: none;
}
            ...
            <section class="app-user-list">
                <div class="row">
                    ...
                    <div class="col-lg-6 col-sm-6">
                        <div class="card">
                            <div class="card-body d-flex align-items-center justify-content-between">
                                <div>
                                    <h3 class="fw-bolder mb-75">{{ $incidentFileCount }}</h3>
                ...
                <div class="card">
                    <div class="card-body border-bottom">
                        <h4 class="card-title">Manage Incident Files</h4>
                        <div class="row">
                    ...
                    <div class="modal modal-slide-in new-incidentfile-modal fade" id="modals-slide-in">
                        <div class="modal-dialog">
                            {!! Form::open(['route' => 'incidentfile.store', 'method' => 'post', 'class' => 'add-new-incidentfile modal-content pt-0', 'id' => 'add_incidentfile' ]) !!}

                                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close">×</button>
                                <div class="modal-header mb-1">
                                    <h5 class="modal-title" id="exampleModalLabel">Add  Incident File </h5>
                                </div>
                                <div class="modal-body flex-grow-1">
                                    ...
                                    <div class="mb-1">
                                      <div class="demo-inline-spacing">
                                          ...
                                          <div class="col-xl-6 nNnncNnol-md-6 col-12">
                                            <div class="form-check form-check-inline">
                                                {!! Form::checkbox('is_region', '1', false, [
                                                    'class' => 'checkbox form-check-input',
                                                    'id' => 'is_region',
                                                    'data-target' => 'is_region',
                                                ]) !!}
                                                <label class="form-check-label" for="is_region">Region Incidence</label>
                                            </div>
                                        </div>
                    ...
                    <!-- Modal to add new region Ends-->
                       ...
                       <div class="modal modal-slide-in editIncidentFileModal fade" id="modals-slide-in">
...
$(function () {
  ...
  var dtUserTable = $('.user-list-table'),
    newUserSidebar = $('.new-incidentfile-modal'),
    newUserForm = $('.add-new-incidentfile'),
    select = $('.select2'),
  ...
  if (dtUserTable.length) {
    ...
    ajax: "{{ route('incidentfile.index') }}", // JSON file to add data
      columns: [
     ...
     
        {
          ...
          render: function (data, type, full, meta) {
            return (
              ...
              '<a href="javascript:;" data-href="incidentfile/'+full['id']+'/edit" class="edit-incidentfile dropdown-item">' +
              feather.icons['file-text'].toSvg({ class: 'font-small-4 me-50' }) +
              'Edit</a>' +
              '<a href="javascript:;" data-href="incidentfile/'+full['id']+'" class="delete-incidentfile dropdown-item delete-record">' +
...
$(document).on('click', '.edit-incidentfile', function() {
   // alert($(this).data('href'));

           
           $('div.editIncidentFileModal').load($(this).data('href'), function() {
               $(this).modal('show');
        
               $('form#edit_incidentfile').submit(function(e) {
                   e.preventDefault();
                   $(this)
                  ...
                  processData:false,
                       success: function(result) {
                           if (result.success == true) {
                               $('div.editIncidentFileModal').modal('hide');
                               Swal.fire({
                     position: 'top-end',
                     icon: 'success',
                     title: result.msg,
       ...
       $(document).on('click', '.delete-incidentfile', function(e) {
                e.preventDefault();
                Swal.fire({
                    type: 'warning',
                  title: "Are You Sure",
                  ...
                  dangerMode: true,
                    ...
                    if (willDelete.value) {
                      ...
                      Swal.fire('Incident File not deleted', '', 'info')
                    }
                });
            });
