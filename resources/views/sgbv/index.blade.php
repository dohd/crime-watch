                    ...
                    <div class="col-md-12">
                        <div class="card shadow-none bg-transparent border-primary">
                            <div class="card-header">
                                <h4 class="card-title">SGBV REPORT</h4>
                            </div>
                            @php
                            $county_input=null;
                            ...
                            @endphp
                            <div class="card-body">
                                {!! Form::open(['route' => 'sgbv.index', 'method' => 'GET', 'class' => ' modal-content pt-0', 'id' => 'search-report']) !!}
                                ...
                                <div class="row">
                                        ...
                                        <div class="col-xl-4 col-md-6 col-12">
                                            <div class="mb-1">
                                                <label class="form-label" for="report_number">County</label>
                                                {!! Form::select('county_id', $counties, $county_input, [
...
@include('sgbv.reports.bycounty')
    
@else

@include('sgbv.reports.allcounties')
