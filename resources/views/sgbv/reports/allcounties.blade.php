<section id="basic-input">
    <div class="card bg-primary text-white">
        <div class="card-header">
            <h4 class="card-title text-white">NATIONWIDE SGBV REPORT REPORT </h4>
            <a class="btn btn-warning" href="{{ route('print-sgbv-report-all', [encrypt_data($daterange)]) }}" target="_blank">
